...
<section class="address">
    ...
    <div class="status" style="margin-top: -280px">
        <h1 style="font-size: 12px">${
          Number(balanceDue) <= 0 ? "Reçu" : "Facture"
        }</h1>
        ...
        <p class="title"  style="font-size: 8px">Date d'échéance</p>
...
<table>
  <tr>
    ...
    <th style="font-size: 9px">Nuitées</th>
...
<section class="summary">
    <table>
        <tr>
          <th style="font-size: 9px">Résumé de la facture</th>
          <th></th>
        </tr>
        <tr>
        ...
        <tr>
            <td style="font-size: 10px" >Payé</td>
  ...
  <div>
      <hr>
      <h4 style="font-size: 9px">Arréte la présente facture à la somme de</h4>
